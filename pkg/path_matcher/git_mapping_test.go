...
//}
//
//var _ = DescribeTable("GitMapping_MatchPath", func(e gitMappingMatchPathEntry) {
...
//	}
//},
//	Entry("basePath is equal to the path (base)", gitMappingMatchPathEntry{
...
//	}),
//
//	Entry("path is relative to the basePath (base)", gitMappingMatchPathEntry{
//		baseBase:     filepath.Join("a", "b", "c"),
...
//	}),
//
//	Entry("path is not relative to the basePath (base)", gitMappingMatchPathEntry{
//		baseBase:        filepath.Join("a", "b", "c"),
...
//	}),
//
//	Entry("basePath is relative to the path (base)", gitMappingMatchPathEntry{
//		baseBase:        filepath.Join("a", "b", "c"),
...
//}
//
//var _ = DescribeTable("GitMapping_ProcessDirOrSubmodulePath", func(e gitMappingProcessDirOrSubmodulePath) {
//	pathMatcher := NewGitMappingPathMatcher(e.baseBase, e.includePaths, e.excludePaths)
//
//	for _, matchedPath := range e.matchedPaths {
